...
#Region "IComparer Members"
            ...
            Public Function Compare(ByVal x As QueryParameter, ByVal y As QueryParameter) As Integer Implements IComparer(Of oAuthExample.OAuthBase.QueryParameter).Compare
